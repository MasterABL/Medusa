 ...
 * Projetado para funcionar com legibilidade e harmonia nos 3 temas do Medusa:
 * - Claro (#ECF1ED)
 * - Sépia (#F8F7F0)
 * - Escuro (#111614)
 *
...
export const PASTEL_PALETTE: PastelColorDefinition[] = [
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FAF0F1', border: '#ECC4CB', text: '#7E3644', accent: '#CE7282', subtle: '#F5E6E8' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FDF3EC', border: '#F3CCB7', text: '#87401E', accent: '#D97948', subtle: '#F8E9DE' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FAF0EB', border: '#EEC2B3', text: '#8E3B2A', accent: '#CF654F', subtle: '#F5E4DC' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FBF3E8', border: '#F0CAA1', text: '#824816', accent: '#CF7B30', subtle: '#F7EBDC' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FAF4E5', border: '#ECD28F', text: '#724E0A', accent: '#C48D1B', subtle: '#F5ECDA' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#FAF7E4', border: '#EFE0A1', text: '#675811', accent: '#B79E25', subtle: '#F4EFCF' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F6F8E7', border: '#D3DF97', text: '#525F0F', accent: '#93A721', subtle: '#EEF2D5' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EDF7EE', border: '#AEDAB9', text: '#1D5831', accent: '#449C65', subtle: '#E1EFE3' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EFF4EE', border: '#B4C9B7', text: '#2F4F35', accent: '#54825D', subtle: '#E4ECE3' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F3F6E8', border: '#C3D49F', text: '#435320', accent: '#718D34', subtle: '#E9EED8' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EAF6F0', border: '#A6DACB', text: '#155746', accent: '#31967D', subtle: '#DDF0E7' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#E8F6F3', border: '#A1D6CD', text: '#13544F', accent: '#2F938A', subtle: '#DAEEEB' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#E8F3F7', border: '#A4D1DF', text: '#124E60', accent: '#2B89A4', subtle: '#DCEDF2' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EAF1F8', border: '#A9C9EA', text: '#184874', accent: '#3279BD', subtle: '#DCE7F2' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EFF2F5', border: '#B3C1CE', text: '#2F4253', accent: '#546F88', subtle: '#E2E7ED' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#EEF0FA', border: '#B2BDE9', text: '#27367B', accent: '#4D61C0', subtle: '#E0E4F4' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F0EFF8', border: '#B9B4E6', text: '#352F75', accent: '#6157B5', subtle: '#E3E0F2' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F4EEF8', border: '#C7ADE7', text: '#4D2877', accent: '#864DBD', subtle: '#EBE2F3' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F6EFF8', border: '#D2B2E4', text: '#5D2E70', accent: '#9752B1', subtle: '#EEE2F2' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F4EEF3', border: '#CBB1C7', text: '#593455', accent: '#875482', subtle: '#EAE1E8' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F5EEF0', border: '#D1AFBB', text: '#673444', accent: '#97546A', subtle: '#ECE0E4' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F7EFEA', border: '#D8B2A6', text: '#6E3A2D', accent: '#A25D4C', subtle: '#EDE1DC' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F6F1EA', border: '#D0C2B1', text: '#574532', accent: '#857057', subtle: '#EAE3D9' },
  ...
  },
  {
    ...
    themes: {
      ...
      sepia: { bg: '#F2F1F4', border: '#BFBCCB', text: '#433F50', accent: '#6B667F', subtle: '#E5E4E9' },
