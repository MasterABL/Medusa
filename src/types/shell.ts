...
/**
 * Fonte única de verdade da geometria do Shell. Antes desta função existirem 4 cálculos
 * independentes (Sidebar, ContextPanel, ShellLayout, Header), cada um com seus próprios
 * literais 240/68/320/260 hardcoded — a causa raiz do Context Panel nunca recolher de verdade
 * (a largura do box model nunca chegava a 0px, só era deslocada via transform). Ver
 * .ai/BLOCKERS.md -> BLOCK-008.
 */
