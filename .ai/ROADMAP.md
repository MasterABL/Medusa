...
| Agenda | EXPERIENCE EM REFINAMENTO | PR #6 (base) + PR #9 (motion/Island/UX) + PR #12 (conflitos N-a-N, prioridade, sugestões, recorrência "Personalizado") + PR #16 (copy), Gates 1-10 provado, sem Human Experience Gate nem merge |
| Educação | EXPERIENCE EM REFINAMENTO | PR #7 (motion/espaço/Island) + PR #13 (rótulo ENEM, altura do player) + PR #15 (Study Mode consolidado ENEM/Inglês/Faculdade) + PR #16 (copy) sobre base já provada; sem Human Experience Gate nem merge |
